...
import com.ecash.ecashcore.model.QUserHistory;
...
public interface UserHistoryRepository extends JpaRepository<UserHistory, String>,
    QueryDslPredicateExecutor<UserHistory>, QuerydslBinderCustomizer<QUserHistory> {
  
  @Override
  default public void customize(QuerydslBindings bindings, QUserHistory userHistory) {
