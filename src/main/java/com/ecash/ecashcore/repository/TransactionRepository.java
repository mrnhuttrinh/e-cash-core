    ...
    extends BaseQuerydslRepository<Transaction, String, QTransaction>
{
  ...
  default public void customize(QuerydslBindings bindings, QTransaction transaction)
  {
    ...
    bindings.bind(Date.class)
        .all((final DateTimePath<Date> path, final Collection<? extends Date> values) -> {
    ...
    bindings.bind(Double.class)
        .all((final NumberPath<Double> path, final Collection<? extends Double> values) -> {
